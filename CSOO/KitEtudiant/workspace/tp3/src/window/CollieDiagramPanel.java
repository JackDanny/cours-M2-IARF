...
public final class CollieDiagramPanel extends JPanel {
	...
	public static CollieDiagramPanel getCollieDiagramPanel() {
		return collieDiagramPanel;
	}
	...
	private void assembleToolBar() {
		...
		for (int k = 0; k < actions.length; k++) {
			...
			if (action == null)
				...
				button.setActionCommand("Toolbar:"
	...
	private CollieModelPanel collieModelPanel = CollieModelPanel
			.getCollieModelPanel();
