...
public class MultiInstanceSymbol extends NodeElement {
	...
	public void draw(Graphics graphicsContext) {
		...
		graphicsContext.fillRect(bounds.x + HDISPLACEMENT + HDISPLACEMENT,
				bounds.y - VDISPLACEMENT - VDISPLACEMENT, bounds.width,
				bounds.height);
		graphicsContext.setColor(lineColor);
		graphicsContext.drawRect(bounds.x + HDISPLACEMENT + HDISPLACEMENT,
				bounds.y - VDISPLACEMENT - VDISPLACEMENT, bounds.width,
				bounds.height);

		graphicsContext.setColor(Color.white);
		graphicsContext.fillRect(bounds.x + HDISPLACEMENT, bounds.y
				- VDISPLACEMENT, bounds.width, bounds.height);
		graphicsContext.setColor(lineColor);
		graphicsContext.drawRect(bounds.x + HDISPLACEMENT, bounds.y
				- VDISPLACEMENT, bounds.width, bounds.height);

		graphicsContext.setColor(Color.white);
		graphicsContext.fillRect(bounds.x, bounds.y, bounds.width,
				bounds.height);
		graphicsContext.setColor(lineColor);
		graphicsContext.drawRect(bounds.x, bounds.y, bounds.width,
				bounds.height);
